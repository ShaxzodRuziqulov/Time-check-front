<template>
  <button
      ...
      class="relative w-full rounded disabled:!pointer-events-none disabled:!bg-button-disabled-bg disabled:!text-text-tertiary transition-200 active:scale-95 leading-6 whitespace-nowrap"
  >
    <span
        :class="[
        {
...
const variants: Record<TButtonVariants, string> = {
  primary:
      "bg-[#1929B9] text-white hover:bg-[#4B5BE7]",
  secondary:
      "bg-button-secondary-bg hover:bg-button-secondary-bg-hover text-text-primary-inverted",
  "outline-primary":
      "bg-bg-white border-none shadow-inset-1 disabled:border-0 hover:shadow-inset-2 text-text-primary",
  "outline-accent":
      "bg-bg-white border-none shadow-filter-inset-1 disabled:border-0 hover:shadow-filter-inset-2 text-text-primary-brand",
  "ghost-primary": "bg-bg-white disabled:!bg-transparent border-0",
  "ghost-accent":
      "bg-bg-transparent disabled:!bg-transparent border-0 text-text-primary-brand",
  "text-primary":
      "bg-transparent disabled:text-text-tertiary hover:opacity-80 border-none text-text-primary font-bold",
  "text-accent":
      "bg-transparent disabled:text-text-tertiary hover:opacity-80 border-none text-text-primary-brand font-bold",
};
...
const sizes: Record<TButtonSizes, string> = {
  ...
  md: "h-9 px-4 text-sm",
  lg: "h-11 px-4 text-sm leading-20",
